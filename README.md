...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tbcf42k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tbcf42k.containers.anotherwebservice.com/
...
```
git clone git@github.com:LaN1437/container-tbcf42k.git
cd container-tbcf42k
```
...
```
docker attach container-tbcf42k
```
